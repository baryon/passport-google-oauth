...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.get('https://www.googleapis.com/oauth2/v3/userinfo', accessToken, function (err, body, res) {
    ...
    try {
      ...
      // The following profile fields are optional and only present if returned by Google
      if (json.picture) { profile.photos = [{value:json.picture, type:"thumb"}]; };
      if (json.link) { profile.profileUrl = json.link; };      
...
Strategy.prototype.authorizationParams = function(options) {
  ...
  if (options.approvalPrompt) {
   ...
   // https://github.com/nilaft/passport-google-oauth/commit/e9e6a47652ada7bb2b5ddafe39464107faf6c072
  if (options.forcePassword) {
    params['max_auth_age'] = 0;
  }
